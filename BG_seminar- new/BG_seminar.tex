...
\begin{itemize}
	...
	\item qubit reduction and symmetries 
\end{itemize}
...
\color{magenta}
\begin{itemize}
    \item H2 with different basis sets : \url{https://github.com/bavithra-govintharajah/qiskit-community-tutorials/blob/master/chemistry/h2_basis_sets.ipynb}
    \item different qubit mappings
