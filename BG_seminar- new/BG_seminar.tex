...
Basic familiarity with Hartree-Fock theory might prove useful in understanding the hands-on example but it is not a requirement. At the end of this chapter, the reader will feel comfortable with the use of VQAs to solve common optimization problems and have a clear overview of the theory to adjust various parts of the algorithm to suit one's needs.
