...
The purpose of this chapter is to give a short introduction to the art of variational quantum algorithms. This chapter is brief but self-contained and only a solid knowledge of quantum mechanics is assumed. The reader is encouraged to go through the theory and preferably work through the exercises in Chapter 4 of Ref.~\cite{nielsen2011} beforehand to better understand the implementation of VQAs on actual quantum devices. Basic familiarity with Hartree-Fock theory might prove useful in understanding the hands-on example but it is not a requirement and the reader would nevertheless get an overview of how to implement a VQA to solve the electronic structure problem and find the ground state energy of $H_2$ using Qiskit \cite{Qiskit}.
