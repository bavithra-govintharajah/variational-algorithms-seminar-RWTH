...
\begin{enumerate}
    ...
    \item \emph{Gradient-free approaches:} Gradient-free methods rely on evaluating the function on many points in the cost landscape and inferring a minimum from these evaluations.
    \newline  
    \textbf{Advantages:}
    \begin{itemize}
