...
\begin{enumerate}
    ...
    \textbf{Advantages:}
    \begin{itemize}
        \item Works good for complicated energy landscapes that aren't smooth as they don't require the ability to evaluate gradients efficiently.
...
The work presented here is only a part of the continuously growing body of research in variational algorithms\cite{ NationalAcademiesofSciencesEngineering2019}. The history of this field has just started, and many exciting developments await for us.
 }
