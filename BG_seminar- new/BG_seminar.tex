...
\newpage
{\color{red} complete table Quantum Chemistry in the Age of Quantum Computing }
\begin{landscape}
\begin{table}[h!]
\centering
\begin{tabularx}{600pt}{|| X X X X X X X ||}
 \hline
 Architecture & Molecule & \#qubits & Ansatz & Optimization routine & Computed state & Reference \\ [0.5ex] 
 \hline\hline \\ 
 Photonic chip & $HeH^+$ & 2 & hardware-specific parametrized
ansatz  & Nelder- Mead & ground state & cite \\[0.75ex] 
Single trapped & $HeH^+$ & & UCC & Nelder- Mead & ground and excited state & \\[0.5ex] 
Transmon qubits & $H_2$ &  \\[0.75ex] 
\hline
\end{tabularx}
\end{table}
\end{landscape}
