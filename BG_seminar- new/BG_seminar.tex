...
\end{equation}
where $\sigma$ denotes the variance of $X$. Since the variance of $X$ can be assumed to be bounded above by a constant, from Eq.~(\ref{BG:chebyshev}) it can be deduced that 
\begin{equation}
